...
package ext.name.fraser.neil.plaintext;

import ext.name.fraser.neil.plaintext.diff_match_patch.Diff;
import ext.name.fraser.neil.plaintext.diff_match_patch.LinesToCharsResult;
import ext.name.fraser.neil.plaintext.diff_match_patch.Patch;

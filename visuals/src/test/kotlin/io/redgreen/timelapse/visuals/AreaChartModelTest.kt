...
class AreaChartModelTest {
  ...
  fun `deletions with no vertical padding`() {
    ...
    // when
    computePolygonPoints(deletionsOnlyCommits, HUNDRED, HUNDRED, mutableListOf(), outDeletionPoints)
  ...
  fun `insertions and deletions with no vertical padding`() {
    ...
    // when
    computePolygonPoints(commits, HUNDRED, HUNDRED, outInsertionPoints, outDeletionPoints)
